...
//
//import com.n94.common.config.jwt.JwtToken;
//import com.n94.common.config.jwt.JwtUtils;
//import com.n94.common.config.redis.RedisUtil;
//import com.n94.common.constant.CommonConstants;
//import com.n94.common.utils.ConvertUtils;
//import com.n94.frame.service.framework.FrameUserService;
//import com.n94.frame.vo.LoginUser;
...
//            username = sysUser.getUserInfo().getUserName();
//        }
...
//        }
//        // 判断用户状态
//        if ("1".equals(loginUser.getUserInfo().getStatus())) {
//            throw new AuthenticationException("账号已被锁定,请联系管理员!");
//        }
//        // 校验token是否超时失效 & 或者账号密码是否错误
//        if (!jwtTokenRefresh(token, username, loginUser.getUserInfo().getPassword())) {
//            throw new AuthenticationException("Token失效，请重新登录!");
//        }
//
//        loginUser.setLoginTime(System.currentTimeMillis());
//        loginUser.setExpireTime(loginUser.getLoginTime() + JwtUtils.EXPIRE_TIME);
//        return loginUser;
//    }
//
//    /**
